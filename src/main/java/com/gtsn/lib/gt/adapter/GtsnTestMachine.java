 ...
 *
 * <p>继承 {@link TieredEnergyMachine}（tier 1 / LV）以便 #22 机器界面桥接的 GameTest / 自动测试能经
 * {@code IEnergyContainer} 注入并读取真实能量（#24 F1-1：容量 2048 为 tier 派生值，两端一致，
 * 不作为客户端同步证据）；能量容器由 GTCEu 的 {@code NotifiableEnergyContainer} 提供并
